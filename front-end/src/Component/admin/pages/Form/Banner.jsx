      ...
      <Card color="transparent" className={"flex items-center"} shadow={false}>
        ...
        <form onSubmit={handleSubmit} >
          ...
          <div className={"w-80 mt-2"}>
            <label htmlFor="extenalLink" className="block mb-2 text-sm font-medium text-gray-900 ">Path</label>
          ...
          <div className={" w-80 mt-5 justify-around"}>
            <label htmlFor="image" className="block mb-2 text-sm font-medium text-gray-900 ">Status</label>
