                            ...
                            <div className="Box_wrapper__uAKHJ"><h4 className="Box_title__kFB9-">Introduce</h4>
                                <div>
                                    <div className="Profile_participation__SqLYV">
                                        ...
                                        <span>Thành viên của <span className="Profile_highlight__356rX">FCoursera</span> từ <span className="Profile_highlight__356rX">{moment(userInfo.createdAt).format('DD/MM/YYYY')}</span></span>
                                    </div>
                                </div>
                            </div>
