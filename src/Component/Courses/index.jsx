...
import {getCourse} from "../../Redux/api/course";
...
const Course = () => {
    ...
    return (
        <div className={"px-20 mt-10"}>
            <div className={"my-5"}>
                <h2 className={"font-bold text-2xl inline-block mr-4"}>Khoá học miễn phí</h2>
                ...
                {data.map(each => (
                    <section key={each._id}
                        ...
                        <div className="CommonItem_wrapper__1FbHi Home_courseItem__aIeZ4"><a
                            ...
                            <button className="Button_btn__RW1e2 CommonItem_cta-btn__OK+oX">Xem khoá học</button>
