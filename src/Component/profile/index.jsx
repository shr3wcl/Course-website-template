                ...
                <section className="w-fit flex">
                    <section
                        ...
                        <div className="content-left">
                            <div className="Box_wrapper__uAKHJ"><h4 className="Box_title__kFB9-">Introduce</h4>
                                <div>
                                    <div className="Profile_participation__SqLYV">
                                        ...
                                        <span>Thành viên của <span className="Profile_highlight__356rX">English For Kids</span> từ <span className="Profile_highlight__356rX">{moment(userInfo.createdAt).format('DD/MM/YYYY')}</span></span>
                                    </div>
                                </div>
                            </div>
                            <div className="Box_wrapper__uAKHJ"><h4 className="Box_title__kFB9-">Recent Activity</h4>
                                <div>
                                    <div className="Profile_no-result__O7P-W">No recent activity</div>
                                </div>
                            </div>
                        </div>
                    </section>
                    <section
                        ...
                        <div className="Box_wrapper__uAKHJ"><h4 className="Box_title__kFB9-">Courses attended</h4>
                            {data.length ? (
                                <div>
                                    {data.map(each => (
                                ...
                                <div>
                                        <h1>Haven't taken any courses yet</h1>
                                </div>
                            )}
                        </div>
                    </section>
